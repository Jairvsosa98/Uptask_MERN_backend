...
const agregarTarea = async (req, res) => {
    ...
    if (isProyecto.creador.toString() !== req.usuario._id.toString()) {
    ...
    try {
        ...
        isProyecto.tareas.push(tareaAlmacenada._id)
        await isProyecto.save()
...
const eliminarTarea = async (req, res) => {
    ...
    try {
        ...
        await Promise.allSettled([proyecto.tareas.pull(tarea._id), await tarea.deleteOne()])
